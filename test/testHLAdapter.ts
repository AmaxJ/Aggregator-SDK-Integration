...
import { AmountInfo, ClosePositionData, CreateOrder } from '../src/interfaces/V1/IRouterAdapterBaseV1'
import { parseUnits } from 'ethers/lib/utils'
import { toAmountInfoFN } from '../src/common/helper'
import { HL_COLLATERAL_TOKEN, getReferralData } from '../src/configs/hyperliquid/api/client'
import { ethers } from 'ethers'
import { FixedNumber, divFN, mulFN } from '../fixedNumber'
...
const ethMarketId = '1337-HL-ETH'
const btcMarketId = '1337-HL-BTC'
const ntrnMarketId = '1337-HL-NTRN'
const kPepeMarketId = '1337-HL-kPEPE'
...
async function getAvailableToTrade() {
  ...
  att = await hl.getAvailableToTrade(w, undefined)
