...
import {
  ...
  sellLBP,
  start
} from '../src/configs/hyperliquid/lbp'
...
async function testAuthenticateAgent() {
  const data = await hl.authenticateAgent(
    [
      {
  ...
  await execute(wallet, agentWallet, data)
}
...
async function testBuyLBP() {
  await testAuthenticateAgent()

  const params = await buyLBP(1, 1, false, undefined)
  await execute(wallet, agentWallet, [params])
}

async function testSellLBP() {
  await testAuthenticateAgent()

  const params = await sellLBP(3, 0.7, false, undefined)
  await execute(wallet, agentWallet, [params])
}

async function testSpotPerpTransfer() {
  await testAuthenticateAgent()

  const params = lbpSpotPerpTransfer(10, true)
  await execute(wallet, agentWallet, [params])
}

async function testPriceImpact() {
  start()
  const data = await getLBPTokenDetails()
  if (!data) throw new Error('not found')

  console.log((await getTradeEstimation('LONG', '1', false, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('LONG', '10', false, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('LONG', '100', false, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('LONG', '1000', false, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('LONG', '10000', false, data.midPx.toString())).priceImpact.toString())

  console.log((await getTradeEstimation('SHORT', '1', false, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('SHORT', '10', false, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('SHORT', '100', false, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('SHORT', '1000', false, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('SHORT', '10000', false, data.midPx.toString())).priceImpact.toString())

  console.log((await getTradeEstimation('LONG', '1', true, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('LONG', '10', true, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('LONG', '100', true, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('LONG', '1000', true, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('LONG', '10000', true, data.midPx.toString())).priceImpact.toString())

  console.log((await getTradeEstimation('SHORT', '1', true, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('SHORT', '10', true, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('SHORT', '100', true, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('SHORT', '1000', true, data.midPx.toString())).priceImpact.toString())
  console.log((await getTradeEstimation('SHORT', '10000', true, data.midPx.toString())).priceImpact.toString())
}
