...
import type { CloseTradePreviewInfo, OpenTradePreviewInfo, PreviewInfo } from '../../interfaces/V1/IRouterAdapterBaseV1'
...
export const NOT_ENOUGH_LIQUIDITY = 'Not enough liquidity for trade. Try smaller amount'
