...
import { getSwapFee } from '../../fees/utils'
import { applySwapImpactWithCap, getPriceImpactForSwap } from '../../fees/utils/priceImpact'
import type { MarketInfo, MarketsInfoData } from '../../markets/types'
import { getAvailableUsdLiquidityForCollateral, getOppositeCollateral, getTokenPoolType } from '../../markets/utils'
import { convertToTokenAmount, convertToUsd } from '../../tokens/utils'
import type { SwapPathStats, SwapStats } from '../types'
