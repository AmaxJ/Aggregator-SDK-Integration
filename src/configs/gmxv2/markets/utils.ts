...
import { BASIS_POINTS_DIVISOR } from '../../gmx/tokens'
import { NATIVE_TOKEN_ADDRESS } from '../config/tokens'
import { getCappedPositionImpactUsd } from '../fees/utils/priceImpact'
import { applyFactor, expandDecimals, PRECISION, USD_DECIMALS } from '../lib/numbers'
import type { PositionInfo } from '../positions/types'
...
import type { ContractMarketPrices, Market, MarketInfo } from './types'
...
export function getMaxLeverageByMinCollateralFactor(minCollateralFactor: bigint | undefined) {
  ...
  const x = Number((BigInt(1) * 10n ** BigInt(30)) / minCollateralFactor)
