import type { BigNumber, BigNumberish, ethers, UnsignedTransaction } from 'ethers'

import type { AddressValidationAdditionalSessionData, ERC20ApprovalAddtionalSessionData } from './tx-metadata-types'
import type { ApiOpts } from './V1/IRouterAdapterBaseV1'
