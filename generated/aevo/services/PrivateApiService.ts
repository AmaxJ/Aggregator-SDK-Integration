...
export class PrivateApiService {
    ...
    public getFarmBoost(
        ...
        farm_boost: string
        farm_boost_avg: string
        last_rare_farm_boost: string
        boosted_volume: string
        trailing_volume: string
        prev_epoch_aevo_earned: string
        curr_epoch_aevo_earned: string
        staked: boolean
        airdropped_farm_boost_level: number
        random_farm_boost_eligible: boolean
    }> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/farm-boost',
